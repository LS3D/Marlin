...
#define STRING_CONFIG_H_AUTHOR "(Florian Heilmann, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_BASE_VORON
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "VORON V022"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 174.47
  #define  DEFAULT_bedKi 26.49
  #define  DEFAULT_bedKd 287.28
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 30, 70 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 259
  #define FRONT_PROBE_BED_POSITION 34
  #define BACK_PROBE_BED_POSITION 242
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 13 //((X_MIN_POS + X_MAX_POS) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 133 //((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
